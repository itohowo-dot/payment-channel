...
feat: Add functions to fund and close payment channels

- Implemented `fund-channel` to add funds to an existing channel
- Implemented `close-channel-cooperative` to close channels with agreement from both parties